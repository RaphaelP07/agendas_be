...
RSpec.describe "/organisations", type: :request do
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_organisation_url(organisation), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested organisation" do
        organisation = Organisation.create! valid_attributes
        patch api_v1_organisation_url(organisation),
  ...
  describe "DELETE /destroy" do
    it "destroys the requested organisation" do
      organisation = Organisation.create! valid_attributes
      expect {
        delete api_v1_organisation_url(organisation), headers: valid_headers, as: :json
      }.to change(Organisation, :count).by(-1)
    end
  end
end
