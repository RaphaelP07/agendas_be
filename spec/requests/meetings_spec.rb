...
#   # MeetingsController, or in your router and rack
...
#       get meetings_url, headers: valid_headers, as: :json
...
#         expect {
#           post meetings_url,
#                params: { meeting: valid_attributes }, headers: valid_headers, as: :json
...
#         expect {
#           post meetings_url,
#                params: { meeting: invalid_attributes }, as: :json
#         }.to change(Meeting, :count).by(0)
#       end

#       it "renders a JSON response with errors for the new meeting" do
#         post meetings_url,
#              params: { meeting: invalid_attributes }, headers: valid_headers, as: :json
...
#               params: { meeting: new_attributes }, headers: valid_headers, as: :json
#         meeting.reload
...
#       meeting = Meeting.create! valid_attributes
#       expect {
#         delete meeting_url(meeting), headers: valid_headers, as: :json
#       }.to change(Meeting, :count).by(-1)
#     end
#   end
# end
